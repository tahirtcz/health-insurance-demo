export default function decorate(block) {
  ...
  divEl.setAttribute('class', 'custom_container home_banner');

  const divEl2 = document.createElement('div');
  divEl2.setAttribute('class', 'bullet_container');
  ...
  divEl3.setAttribute('class', 'bullet_subheading_cont');
  ...
  divEl4.setAttribute('class', 'flex_reverse userDetail');

  const divEl5 = document.createElement('div');
  divEl5.setAttribute('class', 'first_cont_data');
  ...
  divEl6.setAttribute('class', 'mobile_flex_container');

  const divEl7 = document.createElement('div');
  divEl7.setAttribute('class', 'banner_img_cont');
  ...
  divEl8.setAttribute('class', 'pointer_cont');
  ...
  divEl13.setAttribute('class', 'form_data fourstepper new-form');
  ...
  divEl14.setAttribute('class', 'step1 form-step');

  const divEl15 = document.createElement('div');
  divEl15.setAttribute('class', 'stepper');

  const divEl16 = document.createElement('div');
  divEl16.setAttribute('class', 'stepper_border');
  ...
  divEl17.setAttribute('class', 'discount_sticker_cont');
  ...
  divEl18.setAttribute('class', 'form_cont');

  const divEl19 = document.createElement('div');
  divEl19.setAttribute('class', 'd_flex');
  ...
  // inputEl5.setAttribute('oninput', 'return isNumber(event, this, 10,'
  //     mobile ');');
  // inputEl5.setAttribute('data-mobile-no', '');
  // inputEl5.setAttribute('onkeyup', 'changeInputType(event, '
  //     tel ')');
  ...
  divEl18.append(buttonEl);

  const divEl21 = document.createElement('div');
  divEl21.setAttribute('class', 'tnc_popup');
  ...
  divEl18.append(labelEl3);
  divEl14.append(divEl18);
  formEl.append(divEl14);

  const divEl22 = document.createElement('div');
  divEl22.setAttribute('class', 'step2 form-step Cr-PreQuote-InsuredDetails');
  ...
  divEl23.setAttribute('class', 'stepper');
  ...
  divEl24.setAttribute('class', 'select_member');

  const divEl25 = document.createElement('div');
  divEl25.setAttribute('class', 'member_list align_middle');
  ...
  divEl30.append(inputEl12);

  const spanEl26 = document.createElement('span');
  spanEl26.setAttribute('class', 'plus');
  spanEl26.textContent = '+';
  divEl30.append(spanEl26);
  labelEl7.append(divEl30);
  divEl29.append(labelEl7);
  divEl24.append(divEl29);

  const divEl31 = document.createElement('div');
  divEl31.setAttribute('class', 'member_list align_middle');
  ...
  divEl31.append(labelEl8);
  divEl24.append(divEl31);
  ...
  divEl32.append(labelEl9);
  divEl24.append(divEl32);
  ...
  divEl33.append(labelEl10);
  divEl24.append(divEl33);
  ...
  divEl34.append(labelEl11);
  divEl24.append(divEl34);

  const smallEl4 = document.createElement('small');
  smallEl4.setAttribute('class', 'error_msg');
  divEl24.append(smallEl4);
  divEl22.append(divEl24);
  ...
  divEl22.append(buttonEl2);
  formEl.append(divEl22);

  const divEl35 = document.createElement('div');
  divEl35.setAttribute('class', 'step3 form-step Cr-PreQuote-InsuredAge');
  ...
  h2El2.append(iEl6);
  divEl35.append(h2El2);

  const divEl36 = document.createElement('div');
  divEl36.setAttribute('class', 'stepper');
  ...
  divEl35.append(buttonEl3);
  formEl.append(divEl35);

  const divEl39 = document.createElement('div');
  divEl39.setAttribute('class', 'step4 form-step Cr-PreQuote-City');
  ...
  h2El3.append(iEl7);
  divEl39.append(h2El3);

  const divEl40 = document.createElement('div');
  divEl40.setAttribute('class', 'stepper');
  ...
  divEl39.append(smallEl7);

  const divEl46 = document.createElement('div');
  divEl46.setAttribute('class', 'custom_button_error');
  ...
  divEl46.append(buttonEl4);
  divEl39.append(divEl46);
  formEl.append(divEl39);
  divEl13.append(formEl);
  divEl4.append(divEl13);
  divEl.append(divEl4);
